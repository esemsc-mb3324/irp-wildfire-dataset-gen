...
def check_input_ranges():
    ...
    expected_ranges = {
        ...
        'asp': (0, 360),
        'fuel': (1, 16),
        'firearea': (0, float('inf'))  # Fire area should be non-negative
    }
...
def analyze_fire_area(input_file='input_tracking.txt'):
    df = pd.read_csv(input_file)
...
# Updated to use the correct default input file name
def fire_area_covariance(input_file='input_tracking.txt'):
    df = pd.read_csv(input_file)
...
# Updated to use the correct default input file name
def fire_area_correlation(input_file='input_tracking.txt'):
    df = pd.read_csv(input_file)
...
# Updated to use the correct default input file name
def select_cases_with_most_fire_area(num_cases, input_file='input_tracking.txt'):
    df = pd.read_csv(input_file)
