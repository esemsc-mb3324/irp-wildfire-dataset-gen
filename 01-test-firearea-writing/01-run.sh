...
NUM_FLOAT_RASTERS=7
FLOAT_RASTER[1]=ws   ; FLOAT_VAL[1]=9.5 # Wind speed, mph
FLOAT_RASTER[2]=wd   ; FLOAT_VAL[2]=285.2  # Wind direction, deg
FLOAT_RASTER[3]=m1   ; FLOAT_VAL[3]=19.2  # 1-hr   dead moisture content, %
FLOAT_RASTER[4]=m10  ; FLOAT_VAL[4]=34.1  # 10-hr  dead moisture content, %
FLOAT_RASTER[5]=m100 ; FLOAT_VAL[5]=32.0  # 100-hr dead moisture content, %
...
NUM_INT_RASTERS=8
INT_RASTER[1]=slp     ; INT_VAL[1]=41   # Topographical slope (deg) # perturbed directly
INT_RASTER[2]=asp     ; INT_VAL[2]=192   # Topographical aspect (deg) # perturbed directly
INT_RASTER[3]=dem     ; INT_VAL[3]=0   # Elevation (m)
INT_RASTER[4]=fbfm40  ; INT_VAL[4]=105 # Fire behavior fuel model code (-)
INT_RASTER[5]=cc      ; INT_VAL[5]=51   # Canopy cover (percent)
INT_RASTER[6]=ch      ; INT_VAL[6]=0   # Canopy height (10*meters)
INT_RASTER[7]=cbh     ; INT_VAL[7]=0   # Canopy base height (10*meters)
INT_RASTER[8]=cbd     ; INT_VAL[8]=18   # Canopy bulk density (100*kg/m3)

LH_MOISTURE_CONTENT=50.4 # Live herbaceous moisture content, percent
LW_MOISTURE_CONTENT=72.3 # Live woody moisture content, percent
